...
pub(super) trait StrictRouteOperations {
    type Session;
...
pub(super) struct StrictRouteSession<O: StrictRouteOperations> {
    operations: O,
...
impl<O: StrictRouteOperations> StrictRouteSession<O> {
    pub(super) fn open(mut operations: O) -> Result<Self, Error> {
    ...
    pub(super) fn health(&self) -> Result<bool, Error> {
...
pub(super) fn strict_route_state_matches<O: StrictRouteOperations>(
    intent: bool,
