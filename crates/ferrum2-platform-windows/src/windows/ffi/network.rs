...
use windows_sys::Win32::Networking::WinSock::{
    ...
    IPPROTO_IP, IPPROTO_IPV6, IPV6_UNICAST_IF, IpDadStateDeprecated, IpDadStatePreferred, SOCKADDR,
    SOCKADDR_IN, SOCKADDR_IN6, SOCKADDR_IN6_0, SOCKADDR_INET, bind as winsock_bind, setsockopt,
};

use super::super::network::{
    InterfaceIdentity, RouteFingerprint, SocketBindingOperations, UnderlayOperations,
    UnderlayPolicy, bind_fixed_with, bind_target_with, same_ip_family, snapshot_underlay_at,
};
...
pub(super) trait ResolvedSocketBindingOperations {
    fn bind_interface(
        &mut self,
...
pub(super) fn bind_resolved_socket_with(
    destination: std::net::SocketAddr,
    resolved: &ResolvedInterface,
...
pub(super) trait SocketAddrScopeExt {
...
pub(super) fn interface_socket_option(
    family: std::net::IpAddr,
    interface_index: u32,
) -> (i32, i32, u32) {
    match family {
...
pub(super) const fn ipv4_interface_index_option_value(interface_index: u32) -> u32 {
    interface_index.to_be()
}

pub(super) const fn ipv6_interface_index_option_value(interface_index: u32) -> u32 {
    interface_index
}
...
pub(super) struct CatalogInterfaceRow {
    pub(super) identity: InterfaceIdentity,
    pub(super) name: Box<str>,
    pub(super) operational: bool,
    pub(super) connected: bool,
    pub(super) kind: NetworkInterfaceKind,
}
...
#[derive(Clone, Debug, Eq, PartialEq)]
pub(super) struct CatalogFamilyRow {
    pub(super) identity: InterfaceIdentity,
    pub(super) family: NetworkFamily,
    pub(super) addresses: Vec<std::net::IpAddr>,
    pub(super) connected: bool,
    pub(super) interface_metric: u32,
    pub(super) default_route_metric: Option<u32>,
}

#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub(super) struct CatalogDefaultRoute {
    pub(super) identity: InterfaceIdentity,
    pub(super) family: NetworkFamily,
...
pub(super) fn build_network_interface_observations(
...
pub(super) const MANAGED_CAPTURE_ROUTE_METRIC: u32 = 1;
...
pub(super) fn socket_addr_sockaddr(address: std::net::SocketAddr) -> SOCKADDR_INET {
    match address {
...
pub(super) fn ipv4_sockaddr(address: std::net::Ipv4Addr) -> SOCKADDR_INET {
    SOCKADDR_INET {
        Ipv4: SOCKADDR_IN {
            sin_family: AF_INET,
            sin_port: 0,
...
pub(super) fn ipv6_sockaddr(address: std::net::Ipv6Addr) -> SOCKADDR_INET {
    SOCKADDR_INET {
        Ipv6: SOCKADDR_IN6 {
