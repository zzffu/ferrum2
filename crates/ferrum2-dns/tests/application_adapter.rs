...
use ferrum2_dns::{
    ...
    ApplicationResolver, ApplicationResolverAdapter, ApplicationResolverMode, DnsAddressRecords,
    DnsCache, DnsCacheAnswer, DnsCacheKey, DnsCacheQtype, DnsError, DnsServerId, DnsStrategy,
    ResolverGeneration,
};
use ferrum2_net::{TcpResolver, UdpResolver};
