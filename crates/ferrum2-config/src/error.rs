...
pub enum ConfigField {
    ...
    OutboundsBindInterface,
    OutboundsInet4BindAddress,
    OutboundsInet6BindAddress,
    Chains,
    ChainsTag,
    ChainsHops,
    Selectors,
...
impl ConfigField {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::TunUdpBufferedBytesLimit => "tun.udp_buffered_bytes_limit",
            ...
            Self::InboundsType => "inbounds.type",
            Self::InboundsAuth => "inbounds.auth",
            Self::InboundsTls => "inbounds.tls",
            ...
            Self::OutboundsProfile => "outbounds.profile",
            Self::OutboundsAuth => "outbounds.auth",
            Self::OutboundsTls => "outbounds.tls",
            Self::OutboundsDomainResolver => "outbounds.domain_resolver",
            Self::OutboundsDomainStrategy => "outbounds.domain_strategy",
            Self::OutboundsBindInterface => "outbounds.bind_interface",
            Self::OutboundsInet4BindAddress => "outbounds.inet4_bind_address",
            Self::OutboundsInet6BindAddress => "outbounds.inet6_bind_address",
            Self::Chains => "chains",
            ...
            Self::Route => "route",
            Self::RouteDefaultInterface => "route.default_interface",
