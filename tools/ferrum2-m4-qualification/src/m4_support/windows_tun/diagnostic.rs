...
pub(crate) const TCP_REQUEST_WARMUP: Duration = Duration::from_secs(10);
pub(crate) const TCP_REQUEST_ACTIVE: Duration = Duration::from_secs(60);
pub(crate) const TCP_REQUEST_PAYLOAD: usize = 1_024;
pub(crate) const TCP_REQUEST_MINIMUM_TRANSACTIONS: u64 = 1_024;
pub(crate) const TCP_REQUEST_LATENCY_SAMPLE_CAP: usize = 2_000_000;
...
pub(crate) const UDP_LATENCY_SAMPLE_CAP: usize = 2_000_000;
...
pub(crate) const FRAGMENT_RETRY_BUDGET_UNIQUE_DATAGRAMS: u64 = 100_000;
