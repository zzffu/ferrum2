...
| M6-T03 | Move FerrumClient external rows to the public binary and qualify exact SHA | M6-T02 | ready |
...
M6-T02 is integrated at exact SHA `af4433168e4728901c7f305d4a4aabd20c8ee958`；
its product、focused、Full、MSRV and lifecycle gates pass。The user explicitly authorized
T02/T03 commits to bypass the failing test-budget hook and will add a later T04 to repair that
gate；budget remains unpassed and still blocks M6 close。Execute M6-T03 next from this
acceptance state in its own branch and worktree。No remote action is authorized。
