...
| M5-T02 | Atomically switch TCP/UDP and delete native cipher/KDF | M5-T01 | active |
...
Complete and accept M5-T02 from ticket base
`262caffb48c8b3e5b9a572399aac5f6d49b01b67` using `strategy: drain`. M5-T03 hosted
