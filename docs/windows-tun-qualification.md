...
The IPv6-only owned adapter suppresses delayed IPv4 link-local autoconfiguration through the
product's journaled interface policy. Unexpected APIPA creation must not be hidden with a startup
