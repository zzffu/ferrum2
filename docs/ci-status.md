...
| Performance/10k idle | BLOCKED | `M4-BUDGET-001`：required harness driver被pinned rustloc计为1,802行test growth，ticket allowance 120 fail closed；尚无candidate、hosted run或baseline | M4 |
