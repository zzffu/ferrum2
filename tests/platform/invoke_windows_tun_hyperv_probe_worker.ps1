...
if (-not $InternalWorker) { throw 'probe worker requires supervisor capability' }
...
$runnerRelative = 'tests/platform/invoke_windows_tun_hyperv_probe_worker.ps1'
...
Invoke-Ferrum2QualificationHostController `
    -RepositoryRoot $repositoryRoot -Controller MainProbeWorker -Context $context
