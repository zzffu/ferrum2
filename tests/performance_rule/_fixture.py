    ...
    return {
        ...
        "snapshot_lifecycle": {
            ...
            "publish_records": [
                {
                    "sequence": sequence,
                    "reader_generation": sequence,
                    "published_generation": sequence + 1,
                    "returned_old_generation": sequence,
                    "returned_old_matches_reader": True,
                    "fresh_generation": sequence + 1,
                    "live_old_snapshots": sequence,
                    "bytes_allocated": sequence * 1_000,
                    "bytes_deallocated": sequence * 100,
                    "retained_bytes": sequence * 900,
                }
            ...
            "watch_observed_generation": 5,
            "watch_no_missed_publication": True,
            "peak_live_old_snapshots": 4,
            "peak_retained_bytes": 3_600,
            "retained_bytes_measurement": "stats_alloc-0.1.10-isolated-lifecycle-region",
            "release_ns": 1_000,
            "release_deadline_ns": 5_000_000_000,
            "live_old_snapshots_after_release": 0,
            "release_within_deadline": True,
            "all_old_snapshots_released": True,
        },
        "parity_observations": [],
